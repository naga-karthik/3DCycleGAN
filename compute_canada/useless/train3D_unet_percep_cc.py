...
parser.add_argument('--decay_epoch', type=int, default=75, help='epoch from where the learning rate starts linearly decaying to zero')
...
def init_net_gpu(net):
    ...
    # print('Model:', type(net), '\t', "Devices:", net.device_ids)
    net.cuda()
    return net
