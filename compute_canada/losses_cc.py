...
import numpy as np
import sys, os
# os.environ['TORCH_HOME'] = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/compute_canada'
import matplotlib.pyplot as plt
from skimage.filters import sobel_h, sobel_v


def gradient_consistency_loss(real_img, fake_img):
    real_img = real_img.double().numpy()
    fake_img = fake_img.double().numpy()
...
class FeatureLossNet:
    def __init__(self, device):
        ...
        self.criterion_perceptual = nn.L1Loss().cuda()     # using MAE loss
    ...
    def perceptual_loss(self, real_img, cyc_rec_img):
        ...
        original_A = real_img.view(2, 1, 4, 2, 48, 64, 64)
