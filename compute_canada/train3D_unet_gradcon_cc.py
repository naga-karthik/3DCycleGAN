...
parser.add_argument('--decay_epoch', type=int, default=150, help='epoch from where the learning rate starts linearly decaying to zero')
...
for epoch in range(args.epoch, args.n_epochs+1):
    ...
    for i, batch in enumerate(dataloader):
        ...
        loss_gradient_consistency = 2.0 * (loss_gc_A + loss_gc_B)   # 0.3 is the lambda_gc value in paper
