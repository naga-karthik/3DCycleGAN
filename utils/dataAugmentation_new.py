...
# for "MICCAI" data
mic_num = '07'
pth = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/datasets/mr2ct_latest/test_1/A/'
file_name = 'normalized_'+mic_num+'_wat_crpd.npy'
load_path = pth+file_name
