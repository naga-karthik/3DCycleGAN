...
# load_path = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/datasets/spine-1/patient0001/2804506_crpd.npy'
load_path = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/datasets/mr2ct_withScoliotic/train/4540562_crpd.npy'
files = glob.glob(load_path)
save_path = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/datasets/spine-5/patient0463/'
file_name = files[0]
f = file_name.split('/')
print(f[-1][:-4])
ct_data = np.load(file_name) #.squeeze(0)    # loaded as: 48x256x128
print(ct_data.shape, ct_data.dtype, ct_data.min(), ct_data.max())
# sys.exit()
ct_data_1 = np.transpose(ct_data, (2, 1, 0))
ct_data = np.fliplr(np.flip(ct_data_1))
nrrd.write(save_path + f[-1][:-4] + '_resized.nrrd', ct_data)
...
#             'mr2ct_lighterUnet_nmi_batchSize4/realA2fakeB/epoch_' + str(epch) + '/'
# # load_path = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/saved_images/testing_generated/' \
# #             'mr2ct_v3_lighterUnet_gradientConsistency_batchSize4/realA2fakeB/epoch_' + str(epch) + '/'
# path = load_path + '*.npy'
# files = sorted(glob.glob(path))
#
# # save_path = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/nrrd_files/' \
# #             'mr2ct_unet_gradient_consistency/diverse_epoch_' + str(epch)
# save_path = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/nrrd_files/mr2ct_lighterUnet_nmi_batchSize4/' \
#             'epoch_'+str(epch)
# # save_path = '/home/karthik/PycharmProjects/DLwithPyTorch/cycleGAN3D/nrrd_files/' \
# #             'mr2ct_v3_lighterUnet_gradientConsistency_batchSize4/epoch_' +str(epch)
...
#     nrrd.write(save_path + '/test_ep200_' + name + '.nrrd', mri_data_1)
